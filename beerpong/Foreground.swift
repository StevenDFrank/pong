...
class Foreground: SKNode {
    ...
    private func setup() {
        ...
        particlesLarge = GameParticles2.sharedInstance.createParticles(particles: .background)
        particlesMedium = GameParticles2.sharedInstance.createParticles(particles: .background)
        particlesSmall = GameParticles2.sharedInstance.createParticles(particles: .background)
    ...
    func startForeground() {
        for particles in particlesArray {
            particles.particleBirthRate = particles.particleBirthRate * 1.0
...
class Foreground2: SKNode {
    ...
    private func setup() {
        ...
        particlesMedium = GameParticles3.sharedInstance.createParticles(particles: .background)
        particlesSmall = GameParticles3.sharedInstance.createParticles(particles: .background)
